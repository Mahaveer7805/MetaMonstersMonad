  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        monster: {
          fire: "hsl(var(--monster-fire))",
          water: "hsl(var(--monster-water))",
          earth: "hsl(var(--monster-earth))",
          air: "hsl(var(--monster-air))",
          electric: "hsl(var(--monster-electric))",
        }
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "battle-attack": "battle-attack 0.5s ease-in-out",
